...
from app.models.stores.MongoDb.mongodb_models import Sale
import logging
from app.crud.stores.sales import create_sale_collection, get_sale_collection_by_id, update_sale_collection, delete_sale_collection
